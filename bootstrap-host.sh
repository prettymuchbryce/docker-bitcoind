...
BTC_IMAGE=${BTC_IMAGE:-prettymuchbryce/bitcoind}
...
curl https://raw.githubusercontent.com/prettymuchbryce/docker-bitcoind/master/upstart.init > /etc/init/docker-bitcoind.conf
